...
【解法の概略】fastとslowという2つのノードを移動させていく。一度にfastは2個、slowは1個前に進む。
...
step1のコードと比べ、時間はループ1周分なので大きく変わらなそうだし、visitedを使わないためメモリを消費しないのでこちらの方が良さそう。入力がNoneの場合や、ノードが一つの場合もwhile文の条件式で対応できる。
